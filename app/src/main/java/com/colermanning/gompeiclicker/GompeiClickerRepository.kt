...
class GompeiClickerRepository private constructor(context: Context) {
    ...
    fun populateDefaults() {
        executor.execute {
            ...
            addUpgrade("Sugar", "ClickValue", "Gompei eats a sugar cube! He's become a bit hyperactive, now he earns 2x the amount of innovation bucks!", 100, 2.0)
            addUpgrade("Basic Education", "ClickValue", "Gompei receives some basic education! He's learned the basics of how to innovate, and now earns 2.5x the amount of innovation bucks!", 500,2.5)
            addUpgrade("Hay", "ClickValue", "Gompei gets some hay to eat! He thinks it's delicious and is motivated to work harder than before! He now earns 3x points!", 5000,3.0)
            addUpgrade("Watermelon", "ClickValue", "You give Gompei some watermelon as a sweet dessert. He loves it! Each click now earns 3.5x the amount of innovation bucks.", 10000, 3.5)
            addUpgrade("Advanced Education", "ClickValue", "Gompei gets smarter every day! New he's one of the smartest goats around! Each click now earns 4x the amount of innovation bucks.", 30000, 4.0)
            addUpgrade("Steak", "ClickValue", "Goats are normally herbivores, but Gompei has decided to experiment a little bit. Each click now earns 5x the amount of innovation bucks.", 50000, 5.0)
            addUpgrade("Vegetarian Buffet!", "ClickValue", "You give Gompei an assortment of the finest veggies around. He couldn't be happier! Each click now earns 6x points!", 100000, 6.0)
            addUpgrade("Higher Education", "ClickValue", "Gompei has received a world class education at WPI. He is now a true innovator! Each click now earns 10x points!", 523200, 10.0)
        }
    }
